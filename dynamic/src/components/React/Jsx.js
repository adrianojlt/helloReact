        ...
        <>
            <div className="container">
                <div className="row">
                    ...
                    <p className="lead">JSX is an XML/HTML-like syntax used by React that extends 
                        ECMAScript so that XML/HTML-like text can co-exist with JavaScript/React code. 
